...
namespace DACS.Areas.Admin.Controllers
{
    ...
    public class PhonesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,isBlocked")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,isBlocked")] Phone phone)
        {
            if (id != phone.Id)
            {
                return NotFound();
